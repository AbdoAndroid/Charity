...
public class EditPasswordActivity extends AppCompatActivity {
    ...
    void  applyOnDB(){
        if (sharedPreferences.getString("type","").equals("doner")) {
            Doner doner=new Doner(sharedPreferences.getString("id",""),sharedPreferences.getString("name",""),
                    sharedPreferences.getString("phone",""),sharedPreferences.getString("password",""));
            dataRefDonor.child(doner.getId()).setValue(doner);
        }else {
            Charity charity=new Charity(sharedPreferences.getString("id",""),sharedPreferences.getString("name",""),
                    sharedPreferences.getString("charityNum",""),sharedPreferences.getString("phone",""),
